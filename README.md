...
The program runs as a simple executable in your computer’s command line or terminal. No internet connection is needed once installed.
...
- **File won’t open or run:** Make sure you used the correct command in the terminal and your operating system supports running executables. For Mac/Linux, ensure the file has executable permissions.
